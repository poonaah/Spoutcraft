...
public class Colorizer {
	...
	public static void setupBlockAccess(IBlockAccess var0, boolean var1) {
		...
		if (var0 == null) {
			...
			BiomeHelper.instance = new BiomeHelper.Old(var0);
		}
	}
	...
	public static void setupForFog(Entity var0) {
		...
		if (!biomesLogged) {
			...
			while (var1.hasNext()) {
				...
				MCPatcherUtils.log("setupBiome #%d \"%s\" %06x (%d,%d)", new Object[]{Integer.valueOf(var2.biomeID), var2.biomeName, Integer.valueOf(var2.waterColorMultiplier), Integer.valueOf(var3), Integer.valueOf(var4)});
			}
		}
	}
				...
				if (var2.startsWith("palette.block.")) {
					...
					if (var4.isCustom()) {
						...
						for (int var7 = 0; var7 < var6; ++var7) {
							...
							MCPatcherUtils.log("using %s for block %s, default color %06x", new Object[]{var2, var8, Integer.valueOf(var4.colorize())});
						}
					}
				}
			}
